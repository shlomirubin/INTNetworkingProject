...
KEY_PATH=$HOME/.ssh/SRubinKeyPrivate.pem
...
ssh -i $KEY_PATH ubuntu@"$PRIVATE_IP" "cat /home/ubuntu/$(basename $PUB_KEY_PATH) >> ~/.ssh/authorized_keys && rm /home/ubuntu/$(basename $PUB_KEY_PATH)"
